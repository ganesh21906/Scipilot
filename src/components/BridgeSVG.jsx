...
export default function BridgeSVG({ className = '' }) {
  return (
    <svg
      className={className}
    ...
    >
      <defs>
        ...
        <linearGradient id="waterGrad" x1="0" x2="0" y1="0" y2="1">
          <stop offset="0%" stopColor="#062038" />
          <stop offset="100%" stopColor="#021022" />
        </linearGradient>
      ...
      {/* caption */}
      <text x="40" y="48" fill="#9fb0bf" fontSize="12">Cable-stayed bridge — stress overlays and deck span</text>
    </svg>
  )
}
